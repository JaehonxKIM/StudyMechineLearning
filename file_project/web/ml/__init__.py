...
def lang_detect_ml(ori_text) :
    ...
    clf = joblib.load('C:/Users/admin/StudyMechineLearning/file_project/web/ml/model/lang_clf.model')
    
    # 4. 예측 수행, 번역 요청
    y_pred = clf.predict([cnt_norms])
    
    # 5. 정답표 로드
    labels = joblib.load('C:/Users/admin/StudyMechineLearning/file_project/web/ml/model/lang_label')
